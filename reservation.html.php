...
<head>
  ...
  <title>Reservation-Royal Cafe</title>
    ...
    <article>
      ...
      <section class="hero-login " id="home" >
        <div class="container">
          ...
          <h2 style="color: rgba(230, 215, 17, 0.945);" class="h2 section-title">Secure Your Cafe Dining Spot.</h2>

          <p style="color: aliceblue;" class="section-text"> "Plan your visit with ease.
             Reserve your table for a delightful dining experience at our cafe"

          </p>

          <form action="reservation.php" method="post" class="tour-search-form">

              <div class="input-wrapper">
                  <label for="combo" class="input-label">Search For Combos*</label>

                  <select name="combo" required placeholder="Select Combos" class="input-field">
                      <option value="0"> Select a Combo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                      <option value="Breakfast">Breakfast Combos</option>
                      <option value="Lunch">Lunch Combos</option>
                      <option value="Dinner">Dinner Combos</option>
                      <option value="pasta">Pasta Combos</option>
                      <option value="BBQ">BBQ Combos</option>
                      <option value="dessert">Dessert Combos</option>
                  </select>
              </div>

              <div class="input-wrapper">
                  <label for="packs" class="input-label">Number Of Packs*</label>
                  <input type="number" name="packs" id="packs" required placeholder="No.of Packs" class="input-field">
              </div>

              <div class="input-wrapper">
                  <label for="date" class="input-label">Reservation Date**</label>
                  <input type="date" name="date" id="date" required class="input-field">
              </div>

              <div class="input-wrapper">
                  <label for="time" class="input-label">Reservation Time*</label>
                  <input type="time" name="time" id="time" required class="input-field">
              </div>

              <button type="submit" class="btn btn-secondary">Pre-Reserve Now</button>
