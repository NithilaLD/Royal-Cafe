    ...
    <article>
      ...
      <section class="hero-about" id="home">
        <div class="container">
          ...
          <h4 class="h4 hero-title">Wanna Know Us </h4>
          ...
          <div class="btn-group">
            <button class="btn btn-primary" onclick="window.location.href='index.html.php'" >Learn more</button>
       ...
       <section class="popular" id="Recipes">
        <div class="container">
          ...
          <p class="section-text"> "Discover a world of deliciousness with our handpicked recipes. 
            Dive into a variety of dishes designed to excite your taste buds. At Royal Cafe,
             we're all about creating simple yet mouthwatering experiences. Come, savor the flavors!"  </p>

             <center>  <figure class="card-img">
              <video  alt="video royalcafesrilanka" loading="lazy" autoplay controls muted>
                <source src="./assets/video/foodvideo.mp4" type="video/mp4">
              </video>
            </figure>
          </center>

          <p class="section-text"> 
            "Embark on a culinary journey with our carefully curated recipes.
             Immerse yourself in a variety of dishes, each crafted with precision to delight and satisfy your taste buds."
       ...
       <section class="tour-search">
        <div class="container">
          ...
          <p style="color: aliceblue;" class="section-text"> "Make your visit stress-free. Secure your spot for a delightful dining adventure at our cafe.
             Reserve your table now for a memorable experience!"
          </p>
          
          <center>  <figure class="card-img">
              <img src="./assets/images/other/royallocation.jpg" alt="location Royalcafesrilanka" loading="lazy">
            </figure>
          </center>
          ...
          <br>
            ...
            <a href="https://www.google.com/search?q=royalcafesrilanka&oq=ro&gs_lcrp=EgZjaHJvbWUqBggAEEUYOzIGCAAQRRg7MgYIARBFGDkyBggCEEUYOTIGCAMQRRg5MgYIBBBFGDwyBggFEEUYPDIGCAYQRRg8MgYIBxAuGEDSAQgzOTYzajBqMagCALACAA&sourceid=chrome&ie=UTF-8#cobssid=s&rlimm=16589102322150116964"><button type="submit" class="btn btn-secondary">Show More</button></a>
    ...
    <!---#POPULAR RECIPES-->
      ...
      <section class="popular" id="Recipes">
        <div class="container">
          ...
          <p class="section-text"> "Open the door to a realm of culinary delights with our thoughtfully curated recipes. 
            Delve into a diverse selection of dishes, each expertly crafted to captivate and satisfy your taste buds."
            ...
            <li>
              <div class="package-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/food/desert.jpg" alt="Experience The Great Holiday On Beach" loading="lazy">
                </figure>
      ...
      <section class="gallery" id="gallery">
        <div class="container">
         ...
         <center> <button class="btn btn-primary" onclick="window.location.href='gallery.html.php'">View All Packages</button></center>
