...
<body id="top">
  ...
  <main>
    <article>
      ...
      <section class="hero-menu" id="home">
        <div class="container">

          <h4 class="h4 hero-title">Wanna Taste Foods </h4>
          <h1 class="h1 hero-title">Menu!</h1>
       ...
       <section class="package" id="package">
        <div class="container">
          ...
          <button class="btn btn-primary" onclick="window.location.href='login.html.php'">View All Packages</button>
    ...
    <!---#POPULAR RECIPES-->
      ...
      <section class="popular" id="Recipes">
        <div class="container">
          ...
          <button class="btn btn-primary" onclick="window.location.href='login.html.php'">More Recipes</button>
      ...
      <section class="gallery" id="gallery">
        <div class="container">
         ...
         <center> <button class="btn btn-primary" onclick="window.location.href='reservation.html.php'">View All Packages</button></center>
