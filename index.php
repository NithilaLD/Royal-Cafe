    ...
    <article>
      ...
      <section class="hero " id="home">
        <div class="container">
          ...
          <h1 class="h1 hero-title">Royal Cafe!</h1>
    ...
    <!---#POPULAR RECIPES-->
              ...
              <div class="popular-card">
                ...
                <div class="card-content">
                 ...
                 <!-- <div class="card-rating">
                  ...
                  <p class="card-text">
                    "Journey through time with<br> our traditional cuisine." </p>
            ...
            <li>
              <div class="popular-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-text">
                    "Embark on a gastronomic journey<br> to the West."    
                                </p>
            ...
            <li>
              <div class="popular-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-text">
                    "Experience timeless flavors with<br> our classic cuisine recipes."                 
                   </p>
        ...
        <div class="container">
          ...
          <form action="" class="tour-search-form">
            ...
            <div class="input-wrapper">
             ...
             <button  type="submit"><a  class="btn btn-secondary" href="reservation.html">Pre-Reserve Now</a></button>
      ...
      <section class="package" id="package">
        <div class="container">
          ...
          <button class="btn btn-primary" onclick="window.location.href='menu.index.php'">View All Packages</button>
